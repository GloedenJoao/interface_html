...
class DashboardStore:
    ...
    def add(self, name: str, view_name: str, viz_type: str, columns: Dict[str, Optional[str]], rendered: Dict[str, str]) -> DashboardItem:
    ...
    def update(self, item_id: str, name: str, view_name: str, viz_type: str, columns: Dict[str, Optional[str]], rendered: Dict[str, str]) -> DashboardItem:
